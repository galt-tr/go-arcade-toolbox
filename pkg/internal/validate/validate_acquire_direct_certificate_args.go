...
// AcquireDirectCertificateArgs validates the arguments for a direct
// certificate acquisition (ported from go-wallet-toolbox).
func AcquireDirectCertificateArgs(args *sdk.AcquireCertificateArgs) error {
