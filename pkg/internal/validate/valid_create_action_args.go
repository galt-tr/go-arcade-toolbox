// Package validate is ported from go-wallet-toolbox (see upstream docs).
package validate
...
// ValidCreateActionArgs is ported from go-wallet-toolbox (see upstream docs).
...
// WalletCreateActionArgs is ported from go-wallet-toolbox (see upstream docs).
