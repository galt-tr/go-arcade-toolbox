...
func runMetastoreSuite(t *testing.T, factory storeFactory) {
	...
	t.Run("KnownTx_ReclaimStaleSend", func(t *testing.T) { t.Parallel(); testKnownTxReclaimStaleSend(t, factory) })
	t.Run("Transactions_SetTxIDCAS", func(t *testing.T) { t.Parallel(); testTransactionsSetTxIDCAS(t, factory) })
