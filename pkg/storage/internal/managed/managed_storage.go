// Package managed is ported from go-wallet-toolbox (see upstream docs).
package managed
...
// Storage is ported from go-wallet-toolbox (see upstream docs).
type Storage struct {
...
// NewManagedStorage is ported from go-wallet-toolbox (see upstream docs).
...
// IsAvailable is ported from go-wallet-toolbox (see upstream docs).
func (s *Storage) IsAvailable() bool {
	return s.Settings != nil && s.User != nil
}

// MakeAvailableStorage is ported from go-wallet-toolbox (see upstream docs).
...
// ThinksItIsActive is ported from go-wallet-toolbox (see upstream docs).
func (s *Storage) ThinksItIsActive() bool {
	return s.IsAvailable() && s.User.ActiveStorage == s.Settings.StorageIdentityKey
}

// ThinksActiveStorageIs is ported from go-wallet-toolbox (see upstream docs).
...
// HasStorageIdentityKey is ported from go-wallet-toolbox (see upstream docs).
