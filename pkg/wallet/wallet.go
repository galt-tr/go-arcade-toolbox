// Package wallet is ported from go-wallet-toolbox (see upstream docs).
package wallet
...
import (
	...
	"github.com/galt-tr/go-arcade-toolbox/pkg/wallet/internal/utils"
...
func (w *Wallet) acquireDirectCertificate(ctx context.Context, args sdk.AcquireCertificateArgs, originator string) (*sdk.Certificate, error) {
	...
	if err := validate.AcquireDirectCertificateArgs(&args); err != nil {
