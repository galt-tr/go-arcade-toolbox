// Package wallet_settings_manager is ported from go-wallet-toolbox (see upstream docs).
...
// NewWalletSettingsManager is ported from go-wallet-toolbox (see upstream docs).
...
// DefaultManager is ported from go-wallet-toolbox (see upstream docs).
