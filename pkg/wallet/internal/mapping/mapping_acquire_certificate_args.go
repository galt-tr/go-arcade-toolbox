...
// MapToCertifierCounterparty is ported from go-wallet-toolbox (see upstream docs).
...
// MapToFieldsForEncryption is ported from go-wallet-toolbox (see upstream docs).
